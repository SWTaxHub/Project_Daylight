...
check_emplids(timesheet_cas_OT_daily_weekly, emplids_list, "Initial Load")
...
# New Cut-off date for the calculation Requested by client on 23/05/2025
cutoff_date = pd.to_datetime('2023-11-30').date()
...
check_emplids(timesheet_cas_OT_daily_weekly, emplids_list, "Output DataFrame")
