...
condition_top_up = (
    (Penalties_Recalc['three_hour_top_up_cash'] > 0) |
    (Penalties_Recalc['one_hour_top_up_cash'] > 0) |
    (Penalties_Recalc['two_hour_top_up_cash'] > 0) |
    (Penalties_Recalc['cal_shift_top_up'] > 0)
)
